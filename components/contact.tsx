    ...
    return (
        <section ref={ref} id='contact' className='lg:max-w-[50rem] xxs:w-64 xs:max-w-sm sm:max-w-sm sm:mb-0 md:mb-28 scroll-mt-28 mt-4 xxs:mt-10'>
            ...
            <Sheet>
                ...
                <SheetContent side={'right'} className='bg-gradient-to-r from-blue-100 to-yellow-100'>
                    <SheetHeader>
                    ...
                    <div className="grid grid-cols-2 gap-4 py-4">
                        ...
                        <Button className='col-span-2 mt-4'>Wanna send a specialized Message?</Button>
                    </div>
                </SheetContent>
            </Sheet>
        </section>
